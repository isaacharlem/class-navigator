...
export default function CourseChats() {
  ...
  const createNewChat = async (e: React.FormEvent) => {
    ...
    try {
      ...
      } else if (newChatType === "assignment") {
      ...
      {chats.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="mt-2 text-gray-600">
            Create a new chat to start asking questions about your course
            materials.
          </p>
          <button
            onClick={() => setShowNewChatModal(true)}
          ...
          <div className="relative mt-24 mx-auto max-w-lg p-6 bg-white rounded-lg shadow-xl">
            ...
            <form onSubmit={createNewChat}>
              ...
              <div className="mb-4">
                ...
                >
                  First Message
                  {newChatType === "general" ? " (Optional)" : " (Optional)"}
                </label>
                <textarea
                  id="firstMessage"
                  value={firstMessage}
                  onChange={(e) => setFirstMessage(e.target.value)}
                  placeholder="Type your first message for this chat"
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                  rows={3}
                  required={false}
                />
                {newChatType === "general" && (
                  <p className="mt-1 text-xs text-gray-500">
                    A descriptive chat name will be generated after you send
                    your first message.
                  </p>
                )}
              </div>
              ...
              <div className="flex justify-end space-x-3 mt-6">
                ...
                <button
                  ...
                  disabled={
                    creating ||
                    (newChatType === "assignment" && !assignmentName)
                  }
