    ...
    <div>
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500">{course.description || 'No description'}</p>
        </div>
          ...
          <div className="bg-white shadow rounded-lg overflow-hidden">
            ...
            {documents.length === 0 ? (
              <div className="p-6 text-center">
                <p className="text-gray-500 mb-4">No documents have been uploaded for this course yet.</p>
                <Link
                  href={`/dashboard/courses/${course.id}/upload`}
                  className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700"
                >
          ...
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xl font-semibold">{course._count?.chats || 0}</p>
              </div>
              <div>
